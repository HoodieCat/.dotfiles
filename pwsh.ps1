...
Set-PSReadlineKeyHandler -Key 'Ctrl+t' -ScriptBlock {
	$command = 'fd -tf -I --hidden --follow  --exclude node_modules --exclude .git -E .vscode --exclude undo --exclude swap 2>$null | fzf --tiebreak=length --border --preview "bat -n --color=always {}" --bind "ctrl-h:backward-delete-char"'
		try{
